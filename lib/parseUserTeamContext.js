...
async function parseUserTeamContext(franchiseOrPath) {
    ...
    return {
        ...
        currentOffensiveScheme: myTeam.CurrentOffensiveScheme || null,
        currentDefensiveScheme: myTeam.CurrentDefensiveScheme || null,
        colorPrimary: toHex(myTeam.TEAM_BACKGROUNDCOLORR, myTeam.TEAM_BACKGROUNDCOLORG, myTeam.TEAM_BACKGROUNDCOLORB),
        colorSecondary: toHex(myTeam.TEAM_BACKGROUNDCOLORR2, myTeam.TEAM_BACKGROUNDCOLORG2, myTeam.TEAM_BACKGROUNDCOLORB2),
        grades: {
